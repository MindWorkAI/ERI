...
/// <param name="ConfidenceScore">An optional confidence score between 0 and 1 indicating
/// the confidence of the match. A higher score indicates higher confidence.</param>
